...
import alteredu.stanford.nlp.util.ArrayUtils;
...
public class Clique implements Serializable {
  ...
  protected static final long serialVersionUID = -8109637472035159453l;
  ...
  public static Clique valueOf(int[] relativeIndices) {
    ...
    Clique c = new Clique();          
    c.relativeIndices = ArrayUtils.copy(relativeIndices);
    return intern(c);
  }
