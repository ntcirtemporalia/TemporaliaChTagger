...
/** Flags for sequence classifiers. These flags are mainly defined in the
 *  Javadoc of NERFeatureFactory.
 *
 *  <i>Programming note:</i> Try very hard to only add new variables at the 
 *  end of the list of variables (and not to change existing variables).
...
//  public String testMap = "word=0,tag=1,answer=2";
  ...
  public String normalizationTable = "/u/nlp/data/chinese-segmenter/list_err";
  ...
  public FeatureLabel pad = new FeatureLabel();
    ...
    for (Enumeration e = props.propertyNames(); e.hasMoreElements(); ) {
      ...
      if (key.equalsIgnoreCase("macro")) {
        ...
        if (Boolean.parseBoolean(val)) {
          ...
          // noMidNGrams
          noMidNGrams = true;
          // todo: should this be set?? maxNGramLeng = 6;  No (for best score).
          // reverse
          useReverse = false;
          // typeseqs3
          useTypeSeqs = true;
...
//          trainMap=testMap="word=0,answer=1";
        ...
        if (featureFactory.equalsIgnoreCase("SuperSimpleFeatureFactory")) {
          ...
          featureFactory = "edu.stanford.nlp.ie.NERFeatureFactory";
        } else if (featureFactory.equalsIgnoreCase("ComboFeatureFactory")) {
          featureFactory = "edu.stanford.nlp.sequences.ComboFeatureFactory";
        } else if (featureFactory.equalsIgnoreCase("ComboNERFeatureFactory")) {
          featureFactory = "edu.stanford.nlp.sequences.ComboNERFeatureFactory";
