...
public class XMLUtils {
   ...
   */
  public static final Set breakingTags = new HashSet(Arrays.asList(new String[]{"blockquote", "br", "div", "h1", "h2", "h3", "h4", "h5", "h6", "hr", "li", "ol", "p", "pre", "ul", "tr", "td"}));
   ...
   *
   * @param s
   * @return A String in which all of the special characters of XML have been escaped
   */
