...
public class StanfordCoreNLPWrapper implements PartOfSpeechTagger {
	
	// uima wrapper instance
		private de.unihd.dbs.uima.annotator.stanfordtagger.StanfordCoreNLPWrapper stanfordCoreNLPWrapper = 
				new de.unihd.dbs.uima.annotator.stanfordtagger.StanfordCoreNLPWrapper();
		...
		public void initialize(Properties settings) {
			...
			stanfordCoreNLPWrapper.initialize(aContext);
		}
